        ...
        >
          <Grid item md={6} sm={12}>
            ...
            <Typography
              ...
              fontWeight="400"
            >
              Đồng hành cùng bạn mọi lúc, mọi nơi với những bài tập được gợi ý
              và cá nhân hóa
            </Typography>
            ...
            >
              ...
              >
                <Box
                  sx={{
                    backgroundColor: (theme) =>
                      theme.palette.mode === "dark" ? "#B89F52FF" : "#FFDC6EFF",
                    padding: "36px",
                    marginTop: "20px",
                    marginBottom: "24px",
                ...
                <Box
                  sx={{
                    backgroundColor: (theme) =>
                      theme.palette.mode === "dark" ? "#72ADA2FF" : "#9BEFE0FF",
                    padding: "36px",
                    marginTop: "24px",
                    marginBottom: "20px",
              ...
              >
                <Box
                  sx={{
                    backgroundColor: (theme) =>
                      theme.palette.mode === "dark" ? "#95A42AFF" : "#DCF237FF",
                    padding: "36px",
                    marginTop: "20px",
                    marginBottom: "24px",
                ...
                <Box
                  sx={{
                    backgroundColor: (theme) =>
                      theme.palette.mode === "dark" ? "#B86850FF" : "#FF8D6BFF",
                    padding: "36px",
                    marginTop: "24px",
                    marginBottom: "20px",
            ...
            >
              <Grid item xs={12} sm={6} md={3}>
                <Box
                  sx={{
                    backgroundColor: (theme) =>
                      theme.palette.sectionBackground.secondary,
                    padding: "24px",
                    marginY: "20px",
                    borderRadius: "24px",
                    minHeight: "250px",
