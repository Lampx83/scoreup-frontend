          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Typography variant="p" fontWeight={700} color={"#FFFFFF"}>
                    Giải thích chi tiết
                  </Typography>
                </Button>
              </Box>
...
const getImageAndMessage = (correct) => {
  if (correct >= 25) {
    return {
      image: happyCat,
      message:
        "Woa, hãy giữ vững phong độ này cho kỳ thi kết thúc học phần nhé!",
    };
  } else if (correct >= 20) {
    return {
      image: likeCat,
      message:
        "Tốt lắm! Nhưng mình biết bạn có thể làm tốt hơn! Hãy dành thời gian luyện tập thêm nhé!",
    };
  } else {
    return {
      image: sadCat,
